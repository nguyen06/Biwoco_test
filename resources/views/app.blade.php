...
@section('navbar')
    <nav class=" shadow p-3 navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="pt-2 collapse navbar-collapse m-g-64" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link font-weight-bold" href="#">Marketplace<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link font-weight-bold" href="#">Customers</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link font-weight-bold" href="#">Parterns</a>
                </li>
                <li class="nav-item dropdown font-weight-bold">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Communities
            ...
            <button class="btn btn-outline-success my-sm-0 float-right" type="submit">Sign Up</button>
    ...
    <main>
        <div class="bg-light-dark">
            <div class="pt-5">
                <h1 class="text-center text-dark">Get in Touch</h1>
            </div>
            <p class="text-descript">
                Have a question? Send us a note using the form below and someone from the DigitalOcean team will be in touch soon.
            </p>
            <ul class="www-Tabs-bricks">
                <li class="support">
                    <a>
                        <div>
                            Need Support?
                            <span class="www-Tabs-bricksSubText support_SubText">
                ...
                <li class="sale">
                    <a>
                        <div>
                            Sales Inquiries
                            <span class="www-Tabs-bricksSubText">
                                Contact sales about large deployments
                            </span>
                        </div>
                    </a>
                </li>
        ...
        <div id="content">
            ...
            <div class="container pt-5 w-75">
                <form id="myform" method="post" action="/postSubmit">
                    ...
                    <div class="row pt-3">
                        <div class="col">
                            <div class="inner-addon right-addon form-group{{ $errors->has('contact') ? 'has-error' : '' }}">
                                <a href="#">
                                    <span class="glyphicon glyphicon-asterisk"></span>
                                </a>
                    ...
                    <div class="row pt-3">
                        <div class="col">
                            <div class="inner-addon right-addon form-group{{ $errors->has('subject') ? 'has-error' : '' }}">
                                <a href="#">
                                    <span class="glyphicon glyphicon-asterisk"></span>
                                </a>
                    ...
                    <div class="row pt-3">
                        <div class="col">
                            <div class="inner-addon right-addon form-group{{ $errors->has('message') ? 'has-error' : '' }}">
                                <a href="#">
                                    <span class="glyphicon glyphicon-asterisk"></span>
                                </a>
